...
setwd("~/LSS/IVR/nkmullin/experiments/sc-atac-seq/melas_jci_insight_revision/seurat_downstream/heteroplasmy")
```
...
melas.retina.atac <- subset(retina.atac.no.na, donor == "21_016")
...
# subset out MELAS donor sample
melas.rpechor.atac <- subset(rpechor.atac.no.na, donor == "21_016")
...
melas.retina.atac # 4,622 cells
subset.melas.retina.atac # 3,516 cells

melas.rpechor.atac # 1,135 cells
subset.melas.rpechor.atac # 1,079 cells
